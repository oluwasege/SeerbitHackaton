            ...
            modelBuilder.Entity("SeerbitHackaton.Core.Entities.Company", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CAC = "RTYIUEP",
                            CreationTime = new DateTime(2022, 11, 20, 23, 0, 46, 465, DateTimeKind.Local).AddTicks(9104),
                            IsDeleted = false,
                            Location = "Lagos",
                            Name = "Seerbit"
                        });
            ...
            modelBuilder.Entity("SeerbitHackaton.Core.Entities.CompanyAdmin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            CompanyId = 1L,
                            CreationTime = new DateTime(2022, 11, 20, 23, 0, 46, 465, DateTimeKind.Local).AddTicks(7331),
                            IsDeleted = false,
                            UserId = 2L
                        });
                });
            ...
            modelBuilder.Entity("SeerbitHackaton.Core.Entities.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CompanyId = 1L,
                            CreationTime = new DateTime(2022, 11, 20, 23, 0, 46, 466, DateTimeKind.Local).AddTicks(1025),
                            EmployeeNO = "Seer3089",
                            IsDeleted = false,
                            UserId = 4L
                        },
                        new
                        {
                            ...
                            BankName = "Polaris Bank Limited",
                            CompanyId = 1L,
                            CreationTime = new DateTime(2022, 11, 20, 23, 0, 46, 466, DateTimeKind.Local).AddTicks(1029),
                            EmployeeNO = "Seer3060",
                            IsDeleted = false,
                            UserId = 3L
                        });
            ...
            modelBuilder.Entity("SeerbitHackaton.Core.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 2L,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "7cb05360-66d7-49a2-bd4e-bf83d7cd8e27",
                            CreationTime = new DateTime(2022, 11, 20, 23, 0, 46, 693, DateTimeKind.Local).AddTicks(3669),
                            ...
                            IsSuperAdmin = true,
                            LastLoginDate = new DateTime(2022, 11, 20, 23, 0, 46, 693, DateTimeKind.Local).AddTicks(3687),
                            LastName = "Admin",
                            LockoutEnabled = false,
                            NormalizedEmail = "COMPANYADMIN@SEERBIT.COM",
                            NormalizedUserName = "COMPANYADMIN@SEERBIT.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAECKmgmCmIqI5oeVCuY1aKysQ2GUMCcIkU1lRX/KHxdmG+80ATAdfRX4YZwTIAT5Tsg==",
                        ...
                        new
                        {
                            Id = 1L,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "151b3124-444c-44a0-b24f-42b5c1f3f4e6",
                            CreationTime = new DateTime(2022, 11, 20, 23, 0, 46, 466, DateTimeKind.Local).AddTicks(8991),
                            ...
                            IsFirstTimeLogin = false,
                            IsSuperAdmin = true,
                            LastLoginDate = new DateTime(2022, 11, 20, 23, 0, 46, 466, DateTimeKind.Local).AddTicks(8998),
                            LastName = "User",
                            LockoutEnabled = false,
                            NormalizedEmail = "SUPERADMIN@SEERBIT.COM",
                            NormalizedUserName = "SUPERADMIN@SEERBIT.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAEFi43L1xizbif01PXKlCkYkwS07Lq9SjyY4pXI/maKqYNpLgm4ucDhqSvxKhrD6rtg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "99ae0c45-d682-4542-9ba7-1281e471916b",
                            TwoFactorEnabled = false,
                            UserName = "superadmin@seerbit.com",
                        ...
                        new
                        {
                            Id = 4L,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "b1233e97-b7bc-4469-90fe-88a2dfc2b72e",
                            CreationTime = new DateTime(2022, 11, 20, 23, 0, 46, 543, DateTimeKind.Local).AddTicks(1672),
                            ...
                            IsFirstTimeLogin = false,
                            IsSuperAdmin = true,
                            LastLoginDate = new DateTime(2022, 11, 20, 23, 0, 46, 543, DateTimeKind.Local).AddTicks(1686),
                            LastName = "Employee",
                            LockoutEnabled = false,
                            NormalizedEmail = "EMPLOYEE@SEERBIT.COM",
                            NormalizedUserName = "EMPLOYEE@SEERBIT.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAEAJ8+jMYNRDW3hds0TiRBRVQ8uRio4HwG/nUFps3haMROztCfinkrM9nOxlZC21cMA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "99ae0c45-d682-4542-9ba7-1281e471916b",
                            TwoFactorEnabled = false,
                        ...
                        new
                        {
                            Id = 3L,
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "69933f27-a704-411f-b6cd-9843a8beea3d",
                            CreationTime = new DateTime(2022, 11, 20, 23, 0, 46, 619, DateTimeKind.Local).AddTicks(2773),
                            DateOfBirth = new DateTime(1999, 2, 18, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ...
                            IsFirstTimeLogin = false,
                            IsSuperAdmin = true,
                            LastLoginDate = new DateTime(2022, 11, 20, 23, 0, 46, 619, DateTimeKind.Local).AddTicks(2788),
                            LastName = "Employee",
                            LockoutEnabled = false,
                            NormalizedEmail = "EMPLOYEE2@SEERBIT.COM",
                            NormalizedUserName = "EMPLOYEE2@SEERBIT.COM",
                            PasswordHash = "AQAAAAIAAYagAAAAEHxN0NE61x7XiJNE7h4I6OY3S4o4Wt7RmxKFsHq6AZG+1AVBFKqJL/+nIH66+p4FlA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "99ae0c45-d682-4542-9ba7-1281e471916b",
                            TwoFactorEnabled = false,
